...
const HotJobsCard = ({ job }) => {
  ...
  return (
    <div className="card bg-base-100 w-[290px] lg:w-96 mx-auto shadow-sm border rounded-md hover:translate-y-1 transform transition duration-500">
      ...
      <div className="card-body">
        ...
        <div className="card-actions justify-end items-center mt-4">
          ...
          <Link to={`jobs/${_id}`}><button className="btn btn-primary items-center">Apply Now</button></Link>
        </div>
      </div>
    </div>
  );
